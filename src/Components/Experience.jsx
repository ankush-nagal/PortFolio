        ...
        <div id='Experience' className='p-10 md:p-24'>
            ...
            <div className='flex flex-wrap item-center justify-around '>
                <div className='flex flex-wrap md:w-2/5 gap-8 md:p-12 py-10'>
                    ...
                    <span className='p-3 bg-zinc-950 flex items-center rounded-2xl'>
                        <FaFigma color='#f245E1E' size={50} /></span>
                    <span className='p-3 bg-zinc-950 flex items-center rounded-2xl'>
                        <SiMongodb color='#47A248' size={50} /></span>
                    <span className='p-3 bg-zinc-950 flex items-center rounded-2xl'>
                        <SiRedis color='#FF4438' size={50} /></span>
                </div>
                <div>
                    <div className='flex gap-10 bg-slate-950 bg-opacity-45 mt-4 rounded-lg p-4 items-center'>
                        <FaGoogle color='#4285F4' size={50} />
                        <span className='text-white'>
                            <h2 className='leading-tight'></h2>
                    ...
                    <div className='flex gap-10 bg-slate-950 bg-opacity-45 mt-4 rounded-lg p-4 items-center'>
                        <RiNetflixFill color='#E50910' size={50} />
                        <span className='text-white'>
                            <h2 className='leading-tight'></h2>
                            <p className='text-sm leading-tight font-thin'></p>
                            <ul className='text-sm p-2'>
